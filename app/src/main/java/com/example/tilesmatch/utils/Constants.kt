...
object Constants {
    const val TILES_MATCH_SHARED_PREFS = "tiles_match_shared_preferences"

    const val SHOULD_EXPLAIN_SELECT = "should_explain_select"
    const val SHOULD_EXPLAIN_ASSIST = "should_explain_assist"
    const val SHOULD_EXPLAIN_UNDO = "should_explain_undo"
